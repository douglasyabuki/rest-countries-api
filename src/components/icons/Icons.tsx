  ...
  return (
    ...
    >
      <path
        ...
        className="fill-dark-mode-element transition-colors duration-150 dark:fill-light-mode-element"
      />
    </svg>
  );
};
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="stroke-dark-mode-element dark:stroke-light-mode-element"
        ></path>{" "}
      </g>
    </svg>
  );
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="stroke-light-mode-text transition-colors duration-150 dark:stroke-dark-mode-text"
        ></path>{" "}
      </g>
    </svg>
  );
